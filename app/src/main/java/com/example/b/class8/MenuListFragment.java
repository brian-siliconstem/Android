...
public class MenuListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this.getContext(), "MenuListFragment.onCreate:", Toast.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toast.makeText(this.getContext(), "MenuListFragment.onCreateView:", Toast.LENGTH_SHORT).show();
